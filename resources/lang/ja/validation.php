...
return [
    ...
    */
    ...
    'ends_with' => ':attributeの末尾に:valuesが必要です。',
    'exists' => '指定された:attributeが存在しません。',
    'file' => ':attributeにはファイルを指定してください。',
    'filled' => ':attributeには空でない値を指定してください。',
    'gt' => [
        'numeric' => ':attributeは:valueよりも大きい必要があります。',
        'file' => ':attributeは:value KBよりも大きなデータであることが必要です。',
        'string' => ':attributeは:value文字より多く指定してください。',
        'array' => ':attributeは:value個より多く要素を持つ配列を指定してください。',
    ],
    'gte' => [
        'numeric' => ':attributeは:value以上である必要があります。',
        'file' => ':attributeは最低:value KB以上のデータであることが必要です。',
        'string' => ':attributeは:value文字以上指定してください。',
        'array' => ':attributeは:value個以上要素を持つ配列を指定してください。',
    ],
    ...
    'lt' => [
        ...
        'array' => ':attributeは:value個より少ない要素を持つ配列を指定してください。',
    ],
    'lte' => [
        'numeric' => ':attributeは:value以下である必要があります。',
        'file' => ':attributeは:value KB以下である必要があります。',
        'string' => ':attributeは:value文字以下で指定してください。',
        'array' => ':attributeは:value個以下の要素を持つ配列を指定してください。',
    ],
    'max' => [
    ...
    'required_with_all' => ':valuesのうち全てが指定された時は、:attributeは必須です。',
    'required_without' => ':valuesのうちいずれかが指定されない時は、:attributeは必須です。',
    'required_without_all' => ':valuesのうちいずれも指定されない時は、:attributeは必須です。',
    ...
    'starts_with' => ':attributeは:valuesから始まるように指定してください。',
